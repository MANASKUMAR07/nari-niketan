...
upgraded_code = """const NariAdminMonitor = {
  ...
  async load(btnEl) {
    ...
    const refreshBtn = btnEl || document.querySelector("button[onclick*='NariAdminMonitor.load']");
    let origBtnHtml = '';
    if (refreshBtn) {
...
print("Successfully upgraded NariAdminMonitor with interactive load/refresh, Firestore telemetry sync, and rich tab views!")
